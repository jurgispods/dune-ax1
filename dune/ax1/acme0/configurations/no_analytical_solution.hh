...
#ifndef DUNE_AX1_ACME0_NO_ANALYTICAL_SOLUTION_HH
#define DUNE_AX1_ACME0_NO_ANALYTICAL_SOLUTION_HH
  ...
  NoAnalyticalSolution<GV,RF,dim> >
{
  public:
    ...
    NoAnalyticalSolution(const GV & gv, const Acme0Parameters& params_)
    : BaseT(gv)
    {}
...
#endif /* DUNE_AX1_ACME0_NO_ANALYTICAL_SOLUTION_HH */
