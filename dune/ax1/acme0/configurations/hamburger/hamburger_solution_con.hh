...
#ifndef DUNE_AX1_ACME0_HAMBURGER_SOLUTION_CON_HH
#define DUNE_AX1_ACME0_HAMBURGER_SOLUTION_CON_HH
    ...
    HamburgerCon<GV,RF,dim> >
{
  public:
    ...
    HamburgerCon(const GV& gv_, const Acme0Parameters& params_)
    : BaseT(gv_),
      gv(gv_),
      params(params_),
      time(0.0)
...
#endif /* DUNE_AX1_ACME0_HAMBURGER_SOLUTION_CON_HH */
