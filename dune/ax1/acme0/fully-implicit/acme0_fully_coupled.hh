/*
 * acme0_fully_coupled.hh
 *
 *  Created on: Dec 15, 2011
 *      Author: jpods
 */

#ifndef DUNE_AX1_ACME0_FULLY_COUPLED_HH
#define DUNE_AX1_ACME0_FULLY_COUPLED_HH

#include <dune/ax1/common/tools.hh>

class Acme0FullyCoupled
{
  public:

    template<typename U, typename U_CON, typename U_POT,
             typename INITIAL_U, typename SOLVER, typename GFS,
             typename DIAG_INFO, typename Real>
    static void timeStep(Real time, Real dt, U& uold, INITIAL_U& initialU, U& unew, SOLVER& solver,
...
#endif /* DUNE_AX1_ACME0_FULLY_COUPLED_HH */
