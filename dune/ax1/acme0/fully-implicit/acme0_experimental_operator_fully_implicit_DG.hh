...
#ifndef DUNE_AX1_ACME0_EXPERIMENTAL_OPERATOR_FULLY_IMPLICIT_DG_HH
#define DUNE_AX1_ACME0_EXPERIMENTAL_OPERATOR_FULLY_IMPLICIT_DG_HH
...
class Acme0ExperimentalOperatorFullyImplicitDG
      : public Dune::PDELab::NumericalJacobianVolume<Acme0ExperimentalOperatorFullyImplicitDG
        <ParamCon,ParamPot,FiniteElementMapCon,FiniteElementMapPot> >,
        public Dune::PDELab::NumericalJacobianApplyVolume<Acme0ExperimentalOperatorFullyImplicitDG
        <ParamCon,ParamPot,FiniteElementMapCon,FiniteElementMapPot> >,
        public Dune::PDELab::NumericalJacobianBoundary<Acme0ExperimentalOperatorFullyImplicitDG
        <ParamCon,ParamPot,FiniteElementMapCon,FiniteElementMapPot> >,
        public Dune::PDELab::NumericalJacobianApplyBoundary<Acme0ExperimentalOperatorFullyImplicitDG
        <ParamCon,ParamPot,FiniteElementMapCon,FiniteElementMapPot> >,
        ...
        public Dune::PDELab::InstationaryLocalOperatorDefaultMethods<typename ParamPot::Traits::RangeFieldType>
{
  ...
  public:
    ...
    Acme0ExperimentalOperatorFullyImplicitDG (ParamCon& paramCon_, ParamPot& paramPot_, int intorderadd_=0)
      : paramCon(paramCon_),
        paramPot(paramPot_),
...
#endif /* DUNE_AX1_ACME0_EXPERIMENTAL_OPERATOR_FULLY_IMPLICIT_DG_HH */
