    ...
    void transferData(std::vector<Ax1SimulationState<Real> >& states, const MultiGFS& multigfs_Equi)
    {
      ...
      if(x.size() == 2 && doYCoordinatesMatch)
      {
        ...
        Ax1CoarseToFineGridTransferGridFunction<GV,DGF_POT_Equi,PHYSICS>
          dgfOldPot_FineGrid(gv,dgfOldPot_Equi,physics,nNodesXCoarse-1,equiMembraneGroups,doInterpolate);
        //dgfOldPot_FineGrid.setVerbose(true);
        Ax1CoarseToFineGridTransferGridFunction<GV,DGF_POT_Equi,PHYSICS>
          dgfNewPot_FineGrid(gv,dgfNewPot_Equi,physics,nNodesXCoarse-1,equiMembraneGroups,doInterpolate);
...
//        }
      ...
      Ax1FineToCoarseGridTransferGridFunction<GV,Ax1SubdomainIndexGridFunction<GV,Real,PHYSICS>,
          PHYSICS> subdomainIndexGF_Equi_oneXElem(equilibrationGV,subdomainIndexGF,physics,1); // nElementsXCoarse = 1
