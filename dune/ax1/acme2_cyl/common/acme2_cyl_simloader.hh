...
//        }
      ...
      // Reconstruct pot GFS
      typename Acme2CylTraits::FEM_POT femPot;
      typename Acme2CylTraits::GFS_POT gfsPot_Equi_TEMP(equilibrationGV,femPot);

      // Reconstruct con GFS
      typename Acme2CylTraits::FEM_CON femCon;
      ...
      typename Acme2CylTraits::MultiGFS multigfs_Equi(md_equilibrationGrid, permutation,
