...
public:
  ...
  {
    static_assert(dimension == 2, "This implementation for cylinder coordinates works in 2D only");
    static_assert(dimensionworld == 2, "This implementation for cylinder coordinates works in 2D only");
    static_assert(coorddimension == 2, "This implementation for cylinder coordinates works in 2D only");
    static_assert(mydimension <= 2, "mydimension cannot be greater than 2");
  }
