...
//          debug_jochen << "Skipping intersection coming from membrane element!" << std::endl;
      ...
      typedef typename LFSU::MultiDomainLocalFunctionSpace MultiLFS;
      ...
      const MultiLFS& multiLFS = lfsuPot.multiDomainLocalFunctionSpace();
...
//          }
    ...
    */
                         ...
                         R& r_s) const
    {
      ...
      // TODO Create as class members
      const MultiLFS& multiLFS = lfsuPot_s.multiDomainLocalFunctionSpace();
