...
#ifndef DUNE_AX1_ACME2CYL_TEST_SCALES_NERNST_PLANCK_BOUNDARY_HH
#define DUNE_AX1_ACME2CYL_TEST_SCALES_NERNST_PLANCK_BOUNDARY_HH
...
class TestScalesNernstPlanckBoundary
{
  ...
  public:
    ...
    TestScalesNernstPlanckBoundary(const Acme2CylParameters& params_, const GF_INITIAL_CON& gfInitialCon_)
      : params(params_),
...
#endif /* DUNE_AX1_ACME2CYL_TEST_SCALES_NERNST_PLANCK_BOUNDARY_HH */
