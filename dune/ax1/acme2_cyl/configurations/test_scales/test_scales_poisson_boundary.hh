...
#ifndef DUNE_AX1_ACME2CYL_TEST_SCALES_POISSON_BOUNDARY_HH
#define DUNE_AX1_ACME2CYL_TEST_SCALES_POISSON_BOUNDARY_HH
...
class TestScalesPoissonBoundary
{
  public:
    ...
    TestScalesPoissonBoundary(const Acme2CylParameters& params_, const GF_INITIAL_POT& gfInitialPot_)
    : params(params_),
...
#endif /* DUNE_AX1_ACME2CYL_TEST_SCALES_POISSON_BOUNDARY_HH */
