...
class Membrane2LocalOperator :
public Dune::PDELab::NumericalJacobianApplyVolume<Membrane2LocalOperator<BCType> >,
public Dune::PDELab::NumericalJacobianVolume<Membrane2LocalOperator<BCType> >,
public Dune::PDELab::NumericalJacobianApplyBoundary<Membrane2LocalOperator<BCType> >,
public Dune::PDELab::NumericalJacobianBoundary<Membrane2LocalOperator<BCType> >,
...
public:
	...
	Membrane2LocalOperator (const BCType& bctype_, // needs boundary cond.type
	...
	void alpha_volume (const EG& eg, const LFSU& lfsu, const X& x, const LFSV& lfsv, R& r) const
	{
      ...
      RF f;
      if ( globalpos < 0.0 ) f = physics.elecl.rhsPoissonBoltzmann(u);
      else                   f = physics.elecr.rhsPoissonBoltzmann(u);
