...
#ifndef DUNE_AX1_ACME2_STEP_NERNST_PLANCK_BOUNDARY_HH
#define DUNE_AX1_ACME2_STEP_NERNST_PLANCK_BOUNDARY_HH
...
class StepNernstPlanckBoundary
{
  ...
  public:
    ...
    StepNernstPlanckBoundary(const Acme2Parameters& params_, const GF_INITIAL_CON& gfInitialCon_)
    : params(params_),
...
#endif /* DUNE_AX1_ACME2_STEP_NERNST_PLANCK_BOUNDARY_HH */
