...
#ifndef DUNE_AX1_ACME2_DEFAULT_CONFIG_HH
#define DUNE_AX1_ACME2_DEFAULT_CONFIG_HH
...
#include <dune/ax1/acme2/configurations/custom_potential.hh>
#include <dune/ax1/acme2/configurations/no_analytical_solution.hh>
#include <dune/ax1/acme2/configurations/zero_potential.hh>
#include <dune/ax1/acme2/configurations/default/default_poisson_boundary.hh>
#include <dune/ax1/acme2/configurations/default/default_nernst_planck_boundary.hh>
...
class DefaultConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef DefaultPoissonBoundary<GV,RF,INITIAL_POT> POISSON_BOUNDARY;
    };
...
#endif /* DUNE_AX1_ACME2_DEFAULT_CONFIG_HH */
