#ifndef DUNE_AX1_ACME1_SETUP_NOMEMBRANE_HH
#define DUNE_AX1_ACME1_SETUP_NOMEMBRANE_HH
...
#include <dune/ax1/acme1/operator-split/acme1_operator_split_nomembrane.hh>
...
class Acme1Setup
{
  public:
    ...
    void setup (double dtstart, double tend)
    {
      ...
      Acme1Output acme1Output(gfsCon, gfsPot, unewCon, uPot, physics, 2*degreePot, 2*degreeCon);
      // ==============================================================================================
      ...
      typedef Acme1OperatorSplit<U_CON,U_POT,DirichletValuesCon,DirichletValuesPot,SOLVER_CON,
      //typedef Acme1OperatorSplit<U_CON,U_POT,INITIAL_CON,INITIAL_POT,SOLVER_CON,
                          SOLVER_POT,GFS_CON,GFS_POT,PHYSICS,GV,GO_CON,GO_POT,Real> Acme1OperatorSplit;
      Acme1OperatorSplit acme1OperatorSplit(uoldCon, unewCon, uPot, dirichletValuesCon, dirichletValuesPot,
      //Acme1OperatorSplit acme1OperatorSplit(uoldCon, unewCon, uPot, initialCon, initialPot,
      ...
      acme1OperatorSplit.setMaxIterations(100);
      ...
      while (time<tend-1e-8)
      {
        ...
        acme1Output.getDiagInfo().time = (time+dt);
...
//        Dune::PDELab::constraints( bctypePot, gfsPot, ccPot );
        ...
        acme1Output.getDiagInfo().dt = dt;
        
        acme1OperatorSplit.timeStep(time,dt,acme1Output.getDiagInfo());
...
#endif /* DUNE_AX1_ACME1_SETUP_NOMEMBRANE_HH */
