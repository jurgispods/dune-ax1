...
#ifndef DUNE_AX1_STEP_NERNST_PLANCK_BOUNDARY_HH
#define DUNE_AX1_STEP_NERNST_PLANCK_BOUNDARY_HH
...
class StepNernstPlanckBoundary
{
  ...
  public:
    ...
    StepNernstPlanckBoundary(const GF_INITIAL_CON& gfInitialCon_)
...
#endif /* DUNE_AX1_STEP_NERNST_PLANCK_BOUNDARY_HH */
