...
#include <dune/ax1/acme1/configurations/step/step_solution_con.hh>
#include <dune/ax1/acme1/configurations/step/step_solution_pot.hh>
#include <dune/ax1/acme1/configurations/step/step_initial.hh>
#include <dune/ax1/acme1/configurations/step/step_nernst_planck_boundary.hh>
#include <dune/ax1/acme1/configurations/step/step_poisson_boundary.hh>
...
class StepConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef StepInitial<GV,RF,NUMBER_OF_SPECIES,SOLUTION_CON> INITIAL_CON;
      typedef StepNernstPlanckBoundary<SubGV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
