...
#include <dune/ax1/acme1/configurations/no_analytical_solution.hh>
#include <dune/ax1/acme1/configurations/default/default_poisson_boundary.hh>
#include <dune/ax1/acme1/configurations/default/default_nernst_planck_boundary.hh>
...
class DefaultConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef DefaultNernstPlanckBoundary<SubGV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
