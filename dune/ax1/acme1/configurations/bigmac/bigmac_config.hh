...
#include <dune/ax1/acme1/configurations/bigmac/bigmac_solution_con.hh>
#include <dune/ax1/acme1/configurations/bigmac/bigmac_solution_pot.hh>
#include <dune/ax1/acme1/configurations/bigmac/bigmac_initial.hh>
#include <dune/ax1/acme1/configurations/bigmac/bigmac_nernst_planck_boundary.hh>
#include <dune/ax1/acme1/configurations/bigmac/bigmac_poisson_boundary.hh>
...
class BigmacConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef BigmacInitial<GV,RF,NUMBER_OF_SPECIES,SOLUTION_CON> INITIAL_CON;
      typedef BigmacNernstPlanckBoundary<SubGV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
