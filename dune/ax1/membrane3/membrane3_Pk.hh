...
#include <dune/ax1/membrane3/membrane3_operator.hh>

template<class GV>
void membrane3_Pk (const GV& gv, Physics<double>& physics,
                   std::valarray<double>& x, std::valarray<double>& f)
{
  ...
  std::cout << "constrained dofs=" << cc.size() 
	...
	typedef Membrane3LocalOperator<BCTypeParam> LOP;                // operator including boundary
