...
#ifndef ACME1MD_ITERATION_HH
#define ACME1MD_ITERATION_HH
...
class Acme1MDIteration
{
  public:
    ...
    Acme1MDIteration(typename Traits::U_CON& uCon_, typename Traits::U_POT& uPot_,
...
//        Output::printMultipleComponentCoefficientVector(unewCon_Outside,NUMBER_OF_SPECIES);
        ...
        //acme1MDOutput.writeStep(time+dt);
      }
      debug_verb << "-----------------------------------------------------------------" << std::endl;
