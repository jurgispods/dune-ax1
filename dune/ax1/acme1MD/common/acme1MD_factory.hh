...
#ifndef DUNE_AX1_ACME1MD_FACTORY_HH
#define DUNE_AX1_ACME1MD_FACTORY_HH
...
class Acme1MDFactory
{
  public:
    ...
    static PHYSICS setup(Config& config, const GV& gv, const SubGV& elecGV, const SubGV& membGV,
        Acme1MDParameters& params, std::vector<T>& coords, double dt,
...
#endif /* DUNE_AX1_ACME1MD_FACTORY_HH */
