#ifndef DUNE_AX1_ACME1MD_INITIAL_HH
#define DUNE_AX1_ACME1MD_INITIAL_HH
...
#include <dune/ax1/acme1MD/configurations/zero_potential.hh>
  ...
  InitialStep<GV,RF,numSpecies> >
{
  public:
    ...
    InitialStep(const GV& gv, const Acme1MDParameters& params_)
    : BaseT(gv),
      params(params_),
  ...
  InitialSquarePulse<GV,RF,numSpecies> >
{
  public:
    ...
    InitialSquarePulse(const GV& gv, const Acme1MDParameters& params_)
    : BaseT(gv),
      params(params_)
    {}
  ...
  InitialTrianglePulse<GV,RF,numSpecies> >
{
  public:
    ...
    InitialTrianglePulse(const GV & gv, const Acme1MDParameters& params_)
    : BaseT(gv),
      params(params_)
    {}
...
#endif /* DUNE_AX1_ACME1MD_INITIAL_HH */
