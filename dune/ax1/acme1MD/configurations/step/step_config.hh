...
#ifndef DUNE_AX1_STEP_CONFIG_HH
#define DUNE_AX1_STEP_CONFIG_HH

#include <dune/pdelab/common/function.hh>

#include <dune/ax1/common/electrolyte.hh>
#include <dune/ax1/acme1MD/configurations/step/step_solution_con.hh>
#include <dune/ax1/acme1MD/configurations/step/step_solution_pot.hh>
#include <dune/ax1/acme1MD/configurations/step/step_initial.hh>
#include <dune/ax1/acme1MD/configurations/step/step_nernst_planck_boundary.hh>
#include <dune/ax1/acme1MD/configurations/step/step_poisson_boundary.hh>
...
class StepConfiguration
{
  public:
    ...
    struct Traits
    {
      typedef StepCon<GV,RF,NUMBER_OF_SPECIES>     SOLUTION_CON;
      typedef StepPot<GV,RF,1>                     SOLUTION_POT;
      typedef StepInitialCon<GV,RF,NUMBER_OF_SPECIES,SOLUTION_CON> INITIAL_CON;
      typedef StepInitialPot<GV,RF,1,SOLUTION_POT> INITIAL_POT;
      typedef StepNernstPlanckBoundary<GV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
      typedef StepPoissonBoundary<GV,RF> POISSON_BOUNDARY;
    };
