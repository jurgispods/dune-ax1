...
#include <dune/ax1/acme1MD/configurations/cheeseburger/cheeseburger_solution_con.hh>
#include <dune/ax1/acme1MD/configurations/cheeseburger/cheeseburger_solution_pot.hh>
#include <dune/ax1/acme1MD/configurations/cheeseburger/cheeseburger_initial.hh>
#include <dune/ax1/acme1MD/configurations/cheeseburger/cheeseburger_nernst_planck_boundary.hh>
#include <dune/ax1/acme1MD/configurations/cheeseburger/cheeseburger_poisson_boundary.hh>
...
class CheeseburgerConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef CheeseburgerInitialCon<GV,RF,NUMBER_OF_SPECIES,SOLUTION_CON> INITIAL_CON;
      typedef CheeseburgerInitialPot<GV,RF,1,SOLUTION_POT> INITIAL_POT;
      typedef CheeseburgerNernstPlanckBoundary<GV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
