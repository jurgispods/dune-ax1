...
#ifndef DUNE_AX1_HAMBURGER_SOLUTION_POT_HH
#define DUNE_AX1_HAMBURGER_SOLUTION_POT_HH
  ...
  HamburgerPot<GV,RF,dim> >
{
  public:
    ...
    HamburgerPot(const GV& gv_, const Acme1MDParameters& params_)
    : BaseT(gv_),
      gv(gv_),
      params(params_),
      time(0.0)
...
#endif /* DUNE_AX1_HAMBURGER_SOLUTION_POT_HH */
