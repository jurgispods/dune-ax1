...
#include <dune/ax1/acme1MD/configurations/hamburger/hamburger_solution_con.hh>
#include <dune/ax1/acme1MD/configurations/hamburger/hamburger_solution_pot.hh>
#include <dune/ax1/acme1MD/configurations/hamburger/hamburger_initial.hh>
#include <dune/ax1/acme1MD/configurations/hamburger/hamburger_nernst_planck_boundary.hh>
#include <dune/ax1/acme1MD/configurations/hamburger/hamburger_poisson_boundary.hh>
...
class HamburgerConfiguration
{
  public:
    ...
    struct Traits
    {
      ...
      typedef HamburgerInitialCon<GV,RF,NUMBER_OF_SPECIES,SOLUTION_CON> INITIAL_CON;
      typedef HamburgerInitialPot<GV,RF,1,SOLUTION_POT> INITIAL_POT;
      typedef HamburgerNernstPlanckBoundary<GV,RF,INITIAL_CON> NERNST_PLANCK_BOUNDARY;
